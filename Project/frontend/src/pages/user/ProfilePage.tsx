      ...
      <Card>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: 24 }}>
          ...
          <div>
            ...
            <div style={{ color: '#666', marginTop: 8 }}>{state.user?.roleName || '普通用户'}</div>
          </div>
        </div>
        ...
        >
          ...
          <Descriptions.Item label="真实姓名">{state.user?.fullName || '-'}</Descriptions.Item>
          <Descriptions.Item label="角色">{state.user?.roleName || '-'}</Descriptions.Item>
